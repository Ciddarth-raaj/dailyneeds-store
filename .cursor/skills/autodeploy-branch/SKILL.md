...
description: >-
  Enforces main-autodeploy as the integration branch for this frontend repo.
...
- **Never** commit to, merge into, or push **`main`** unless the user explicitly asks
- Never start feature work from `main`
