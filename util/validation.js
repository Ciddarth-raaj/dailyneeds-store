...
export const Validation = Yup.object({
	...
	fatherName: Yup.string().required("Fill Father Name"),
	dob: Yup.string()
		.max(new Date(), "Must be 15 characters or less")
		.required("Fill Date of birth"),
	permanentAddress: Yup.string().required("Fill Address"),
	gender: Yup.string().required("Choose Gender"),
	blood_group_id: Yup.string().required("Choose BloodGroup"),
	designation_id: Yup.string().required("Choose Designation"),
	store_id: Yup.string().required("Choose Store"),
	department_id: Yup.string().required("Choose Department"),
	...
	email: Yup.string().email("Invalid email").required("Fill Email"),
	...
	employeeId: Yup.number().required("Fill Employee ID"),
	salary: Yup.string().required("Fill Salary"),
