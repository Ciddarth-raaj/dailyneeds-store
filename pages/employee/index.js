...
function Registration() {
	...
	const values = [
		["1", "KEERTHI", "Saravana", "Manager", "12.10/1996", "12/10/2000", "Active", <img src={"/assets/edit.png"} className={styles.icon} />],
		["2", "NAME 1", "Krishna Sweets", "Manager", "12.10/1996", "12/10/2000", "Active", <img src={"/assets/edit.png"} className={styles.icon} />],
	];
