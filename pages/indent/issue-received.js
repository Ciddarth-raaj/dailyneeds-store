...
class issueReceived extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    getIssueByStoreId(store_id) {
        if(store_id !== 'null')
        IssueHelper.getIssueByStoreId(store_id)
        .then((data) => {
    ...
    render() {
        ...
        return (
            <GlobalWrapper title="Indent issues List - Indent Received">
            <Head />
            <Formik
                initialValues={{
                    store_id: '',
                                ...
                                <Flex templateColumns="repeat(3, 1fr)" flexDirection={"column"} gap={6} colSpan={2}>
                                    <Container className={styles.container} boxShadow="lg">
                                        <p className={styles.buttoninputHolder}>
                                            <div>Indent issues List - Indent Received</div>
                                        </p>
                                        <div>
                                            <Table
                                                heading={table_title}
